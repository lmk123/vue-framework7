// https://github.com/nolimits4web/Framework7/blob/v1.6.4/src/js/framework7/proto-device.js
...
if (classNames.length > 0) document.documentElement.classList.add(...classNames)
